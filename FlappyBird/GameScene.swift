...
class GameScene: SKScene ,SKPhysicsContactDelegate {
    ...
    let scoreCategory: UInt32 = 1 << 3      // 0...00100
    ...
    let mySoundAction: SKAction = SKAction.playSoundFileNamed("sound.mp3", waitForCompletion: false)
    //let music = SKAudioNode.init(fileNamed: "sound.mp3")
    ...
    func restart()
    {
        ...
        itemscore = 0
        ItemLabelNode.text = "ItemScore:\(score)"
